...
export const SkillCategory: React.FC<SkillCategoryProps> = ({ category }) => {
  ...
  return (
    <div className="p-6 border border-gray-800 rounded-xl bg-black-100 hover:shadow-purple transition-all duration-300">
      <div className="flex items-center gap-3 mb-6">
        <Icon className="text-purple" size={24} />
        <h3 className="text-xl font-bold">{categoryData.title}</h3>
      </div>
