...
export const CodeBlock: React.FC = () => {
  return (
    <div className="relative w-full max-w-sm sm:max-w-md mx-auto">
      <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 bg-gradient-purple rounded-full blur-3xl opacity-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="p-3 sm:p-4">
          <pre className="text-xs sm:text-sm font-mono">
            <code className="text-gray-300">
              ...
              <br />
              {"  "}name: <span className="text-green-400">'Andreu S.G.'</span>,
              <br /><br />
              {"  "}role: {"{"}
              <br />
              {"    "}primary: <span className="text-green-400">'Dev Team Manager'</span>,
              <br />
              {"    "}focus: <span className="text-green-400">'DevOps | Software dev'</span>,
              <br />
              {"    "}passion: <span className="text-green-400">'Tech Leadership'</span>
              <br />
              {"  "}{"}"}, 
              <br /><br />
              {"  "}expertise: [
